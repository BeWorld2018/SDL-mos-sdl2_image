...
int IMG_InitJPG()
{
    if ( lib.loaded == 0 ) {
        ...
        lib.jpeg_calc_output_dimensions = *(void**)((long)(JFIFBase) - 232);
        lib.jpeg_CreateDecompress = *(void**)((long)(JFIFBase) - 34);
        lib.jpeg_destroy_decompress = *(void**)((long)(JFIFBase) - 46);
        lib.jpeg_finish_decompress = *(void**)((long)(JFIFBase) - 184);
        lib.jpeg_read_header = *(void**)((long)(JFIFBase) - 166);
        lib.jpeg_read_scanlines = *(void**)((long)(JFIFBase) - 178);
        lib.jpeg_resync_to_restart = *(void**)((long)(JFIFBase) - 292);
        lib.jpeg_start_decompress = *(void**)((long)(JFIFBase) - 172);
