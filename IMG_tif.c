...
int IMG_InitTIF()
{
    if ( lib.loaded == 0 ) {
        ...
        lib.TIFFClientOpen = *(void**)((long)(TIFFBase) - 436);
        lib.TIFFClose = *(void**)((long)(TIFFBase) - 82);
        lib.TIFFGetField = *(void**)((long)(TIFFBase) - 40);
        lib.TIFFReadRGBAImage = *(void**)((long)(TIFFBase) - 406);
        lib.TIFFSetErrorHandler = *(void**)((long)(TIFFBase) - 460);
#else
