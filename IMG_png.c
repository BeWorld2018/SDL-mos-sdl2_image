...
int IMG_InitPNG()
{
    if ( lib.loaded == 0 ) {
        ...
        lib.png_create_info_struct = *(void**)((long)(PNGBase) - 64);
        lib.png_create_read_struct = *(void**)((long)(PNGBase) - 70);
        lib.png_destroy_read_struct = *(void**)((long)(PNGBase) - 94);
        lib.png_get_IHDR = *(void**)((long)(PNGBase) - 124);
        lib.png_get_io_ptr = *(void**)((long)(PNGBase) - 256);
        lib.png_get_tRNS = *(void**)((long)(PNGBase) - 358);
        lib.png_get_valid = *(void**)((long)(PNGBase) - 388);
        lib.png_read_image = *(void**)((long)(PNGBase) - 466);
        lib.png_read_info = *(void**)((long)(PNGBase) - 472);
        lib.png_read_update_info = *(void**)((long)(PNGBase) - 496);
        lib.png_set_expand = *(void**)((long)(PNGBase) - 604);
        lib.png_set_gray_to_rgb = *(void**)((long)(PNGBase) - 658);
        lib.png_set_packing = *(void**)((long)(PNGBase) - 718);
        lib.png_set_read_fn = *(void**)((long)(PNGBase) - 742);
        lib.png_set_strip_16 = *(void**)((long)(PNGBase) - 826);
        lib.png_sig_cmp = *(void**)((long)(PNGBase) - 910);
#else
